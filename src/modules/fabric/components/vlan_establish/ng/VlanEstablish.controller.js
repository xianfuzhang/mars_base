...
export class VlanEstablishController {
  static getDI() {
    return [
      '$scope',
      '$rootScope',
  ...
  constructor(...args) {
    this.di = {};
    VlanEstablishController.getDI().forEach((value, index) => {
...
VlanEstablishController.$inject = VlanEstablishController.getDI();
VlanEstablishController.$$ngIsClass = true;