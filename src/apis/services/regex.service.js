export class regexService {
  ...
  constructor(...args) {
    ...
    this.reg = {
      ...
      'vlan_number': /^([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])$/, //1-4096
      'vlanRange': /^(([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])\s*,\s*)*(([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])\s*)|(([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])-([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4]))$/,//1-4096, 10,20,30 10-30
      'excludeVlan': /^(([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])\,){0,7}([1-9]\d{0,2}|[1-3]\d{3}|40[0-8][0-9]|409[0-4])$/, //vlan范围 1~4096, 最多8个，以,分割
      'positive_int': /^[1-9]\d*$/,
